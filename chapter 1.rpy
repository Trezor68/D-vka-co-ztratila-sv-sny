...
label chapter1:
    ...
    play music "audio/01.mp3"
    scene bg mraky
    with fade

    "Pršelo..."

    play audio "audio/ame.ogg" volume 0.25
    ...
    "Z těch myšlenek mě už bolí hlava, neměla bych se tím zabývat, půjdu dál."
    ...
    show text "Kapitola 1.\nZtracený sen" with Dissolve(3.0)

    pause 5

    scene black

    play music "audio/02.mp3"

    "Kana otevřela oči."

    scene bg mraky with Dissolve(2.0)
    ...
    "Uvědomila si, že musí něco udělat."
    ...
    "To si už nepamatovala."

    nvl clear

    "Rozhodla se tedy jít, kam jí nos zavedl."
    ...
    "Myslím, že ano. Ale o čem sakra byl? Přemýšlela."

    "Ale nedokázala si vůbec, ale fakt vůbec vzpomenout."

    "Bylo to, jako by jí někdo násilím vymazal vzpomínky."
    ...
    "Nebyl tu nikdo, kdo by jí násilím mohl vymazat vzpomínky."

    "Byla tu jenom ona a pole."
    ...
    "Najednou si všimla, že je prostředí trošku temnější než předtím."

    "Podívala se vzhůru."

    scene bg mraky

    "Nebe bylo zatemněné. Začalo pršet."

    "Kana ale vůbec necítila, že by na ní ten déšť vůbec padal."

    "Nějak to neřešila a šla dál po té nekonečné cestě."
    ...
    "Déšť byl silnější a silnější, ale Kana se rozhodla jít dál. Furt dál."

    "Možná na konci téhle cesty něco je."
    ...
    "Je něco za tím polem? Nejspíš ne. Říkala si Kana."
    ...
    "Proč to muselo potkat zrovna jí. Udělala někomu něco špatného?"
    ...
    "Ale co když, co když do toho praštím něčím, co není moje tělo?"
    ...
    "Smutná Kana šla dál tedy."

    nvl clear

    scene bg pole

    "Bylo tam sucho i když před chvilkou pršelo."

    "Proč tu bylo sucho?"

    "Těžko říct. Velmi těžko říct."

    "Už tím polem procházela 20 minut. Neviděla konec."
    
    "Co nejdál oko dohlédlo, to bylo jenom pole."
    ...
    play music "audio/04.mp3"

    "Když otevřela oči, viděla temnotu. Obrovskou temnotu."

    "Nikde nebylo nic. Vůbec nic."

    "Vyděšená Kana tedy šla dál, dál, dál a dál."

    "Najednou začala vidět světlo v dálce."

    "Šla tedy ke zdroji toho světla. Co by to mohlo být, říkala si."
    ...
    "„Ano, sestry“ odpověděla ta dívka."

    "Najednou si Kana uvědomila, že se jí ta holka vlastně dotýká a tak se hodně rychle zeptala."
    ...
    show text "A to bylo to poslední, co Kana slyšela, než se probudila."

    pause 2.0

    scene black

    play music "audio/05.mp3"
    ...
    "Najednou si všimla, že má úplně jiný oblečení."
    ...
    show text "Konec první kapitoly!"
