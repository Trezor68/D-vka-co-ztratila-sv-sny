...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Automaticky") action Preference("auto-forward", "toggle")
            textbutton _("Uložit") action ShowMenu('save')
            textbutton _("R.Uložit") action QuickSave()
            textbutton _("R.Načíst") action QuickLoad()
            textbutton _("Nast") action ShowMenu('preferences')
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Spustit") action Start()
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("Zavřít") action Quit(confirm=not main_menu)
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Zobrazení")
                        textbutton _("Okénko (doporučeno)") action Preference("display", "window")
                ...
                vbox:
                    ...
                    textbutton _("Volby") action Preference("after choices", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Rychlost automatického textu")
                ...
                vbox:
                    ...
                    if config.has_music or config.has_sound or config.has_voice:
                        ...
                        textbutton _("Všechno ať zavře piču"):
